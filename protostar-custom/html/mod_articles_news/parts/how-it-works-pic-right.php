...
<div class="row no-gutters-sm ">
    <div class="col-9 col-md-7 border-right border-danger border-wide">
    ...
    <div class="col-3 col-md-5 text-left align-self-center">
        <img 
            src="<?php echo $item->jcFields['article-main-image']->rawvalue; ?>" 
            class="pl-1 img-fluid w-50  w3-hover-sepia rounded-circle" 
        />
    </div>
</div>